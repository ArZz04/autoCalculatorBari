...
<div id="modal-div" class="fixed inset-0 z-10 w-screen overflow-y-auto flex items-end justify-center p-4 text-center sm:items-center sm:p-0  ">
    <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-1/4 sm:max-w-screen-lg">
        <div class="bg-white px-4 py-4 pb-4 pt-5 sm:p-6 sm:pb-4">
            <div class="flex-col sm:flex sm:items-center sm:justify-center">
                    <div class="mx-auto flex h-24 w-24 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                    ...
                    <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <h3 class="text-2xl font-semibold text-gray-900" id="modal-title">INGREDIENTES</h3>
                    <div class="mt-2">
                        ${designDiv}
                    </div>
                </div>
        ...
        <div class=" px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
            <button type="button" id="btn-close-modal" class="mt-3 inline-flex w-full justify-center rounded-md bg-gray-100 px-3 py-2 text-lg font-semibold text-gray-900 hover:bg-gray-500 sm:mt-0 sm:w-auto">Cancelar</button>
        </div>
    </div>
</div>
`;
